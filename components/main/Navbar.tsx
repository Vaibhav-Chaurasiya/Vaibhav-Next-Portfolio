  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50 px-3 sm:px-6">
      <div className="mx-auto w-full max-w-7xl">
        <div className="flex items-center justify-between rounded-full border border-white/10 bg-black/30 backdrop-blur-sm px-4 sm:px-6 py-3 shadow-lg shadow-black/20">
          {/* Brand */}
          ...
          {/* Nav */}
          <nav className="hidden md:flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2">
            <a
              href="#about"
